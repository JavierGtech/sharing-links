...
<AuthCheck>
        <main class="max-w-xl mx-auto">
            ...
            {#if $userData?.username == $page.params.username}
                <h1 class="mt-8 text-3xl text-info mb-4 text-center">
                    @{$userData?.username}
                </h1>
                ...
                {#if showForm}
                    ...
                    >
                        ...
                        <button
                            ...
                            type="submit"
                            class="btn btn-success block">Añade un link</button
                        >

                        <button
                            type="button"
                            class="btn btn-xs my-4"
                            on:click={cancelLink}>Cancelar</button
                        >
                    </form>
                {:else}
                    <button
